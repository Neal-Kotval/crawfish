...
A Slack message **sink** for [Crawfish](https://github.com/Neal-Kotval/crawfish) —
...
See the full walkthrough: **[Contributing a connector](https://github.com/Neal-Kotval/crawfish/blob/main/docs/guide/contributing-a-connector.md)**.
