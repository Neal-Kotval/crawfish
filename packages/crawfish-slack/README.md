...
A Slack message **sink** for [Crawfish](https://github.com/crawfishai/crawfish) —
...
See the full walkthrough: **[Contributing a connector](https://github.com/crawfishai/crawfish/blob/main/docs/guide/contributing-a-connector.md)**.
