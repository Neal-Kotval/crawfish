...
1. Find an open issue — start with the
   [`good first issue`](https://github.com/TODO-maintainer/crawfish/labels/good%20first%20issue)
   and [`connector`](https://github.com/TODO-maintainer/crawfish/labels/connector)
   labels.
...
3. Open a PR that closes the issue. See the
   [PR template](https://github.com/TODO-maintainer/crawfish/blob/main/.github/PULL_REQUEST_TEMPLATE.md): tests, docs, `just check`
   green, and a **DCO `Signed-off-by`** on every commit (`git commit -s`).

Questions? Use
[Discussions](https://github.com/TODO-maintainer/crawfish/discussions) — not a new
issue.
...
[`scripts/seed-github-backlog.sh`](https://github.com/TODO-maintainer/crawfish/blob/main/scripts/seed-github-backlog.sh)) include:
...
[`scripts/seed-github-backlog.sh`](https://github.com/TODO-maintainer/crawfish/blob/main/scripts/seed-github-backlog.sh) — it is
idempotent.
